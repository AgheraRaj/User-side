...
function Home() {
  return (
    <div>
      <section className="bg-[#FFFDF2] px-16 h-screen flex justify-between items-center">
        ...
        <div>
          <div className="flex space-x-3 justify-center items-center bg-white w-xs h-20 rounded-2xl shadow absolute -bottom-9 right-[350px]">
