...
function Home() {
  ...
  return (
    <div>
      ...
      <section className="bg-[#cfffdc] flex flex-col text-center">
      ...
      <section className="flex justify-between items-center px-16 py-16 bg-[#FFFDF2]">
        <div>
      ...
      <section className="flex justify-between items-center px-16 py-16 bg-[#FFFDF2]">
        ...
        <div className="w-4xl flex justify-center relative">
          <div className="flex flex-col justify-center items-center h-fit p-9 rounded-2xl shadow-2xl absolute top-14 -right-5 bg-white">
          ...
          <div className="flex items-center bg-white px-5 h-20 rounded-2xl shadow-2xl absolute -bottom-7 left-0">
      ...
      <section className="bg-[#FFFDF2] flex flex-col text-center py-14">
